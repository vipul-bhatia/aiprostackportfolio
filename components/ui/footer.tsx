          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              <div className="mb-2">
                ...
                <Link href="/" className="inline-block" aria-label="Cruip">
                  <Image className="max-w-full mx-auto md:max-w-none h-auto" src={img} width={70} height={70} alt="Disaster-Relevant Tweets Analysis" />
                </Link>
              </div>
              <div className="text-gray-400">Turbocharge your workflows with next-gen AI solutions. Where elegant design meets powerhouse performance for web and app. Tailored for the tech of tomorrow.</div>
            </div>
            ...
            <div className="md:col-span-8 lg:col-span-7 grid sm:grid-cols-3 gap-8">
              ...
              <div className="text-sm">
                ...
                <ul>
                  <li className="mb-1">
                    <Link href="/" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Email Id-: aiprostacksolutions@gmail.com</Link>
                  </li>
                  <li className="mb-1">
                    <Link href="/" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Phone No-:  <br></br> +91 7851043033</Link>
                  </li>
                </ul>
              </div>
